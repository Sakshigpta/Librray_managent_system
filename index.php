                ...
                <div class="col-md-6 login-form-3">
                    ...
                    <form action="loginadmin_server_page.php" method="get">
                        <div class="form-group">
                            <input type="text" class="form-control" required name="login_email" placeholder="Your Email *" value="" />
                        </div>
                        <!-- <Label style="color:red">*<?php echo $ademailmsg?></label> -->
                        <div class="form-group">
                            <input type="password" class="form-control" required name="login_pasword"  placeholder="Your Password *" value="" />
                        </div>
